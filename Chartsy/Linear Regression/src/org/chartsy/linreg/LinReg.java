...
/**
 * The Linear Regression Indicator
 *
 * @author joshua.taylor
 */
public class LinReg extends Indicator{
    ...
    @Override
    public Indicator newInstance(){ return new LinReg(); }
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i)
    {
        ...
        String[] labels = {"Linear Regression Line:"};
    ...
    public void calculate()
    {
        ...
        lookback = core.linearRegLookback(period);
        core.linearReg(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
