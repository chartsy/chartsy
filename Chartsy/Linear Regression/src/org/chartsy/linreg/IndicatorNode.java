...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Linear Regression Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Linear Regression Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Linear Regression Node] : Method does not exist.", ex);
        }
