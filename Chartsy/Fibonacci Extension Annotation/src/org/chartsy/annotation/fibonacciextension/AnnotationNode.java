        ...
        extends AbstractPropertiesNode
{
    ...
    {
        super("Fibonacci Extension Properties");
    }

    public AnnotationNode(AnnotationProperties annotationProperties)
    {
        super("Fibonacci Extension Properties", annotationProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[FibonacciExtensionNode] : Method does not exist.", ex);
        }
