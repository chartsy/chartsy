 ...
 * @author viorel.gheba
 */
public class FibonacciExtension extends Annotation implements Serializable {
    ...
    public FibonacciExtension(ChartFrame cf) {
        super(cf);
    ...
    public void writeXMLDocument(Document document, Element parent) { writeToXMLDocument(document, parent, "Fibonacci Extension"); }
