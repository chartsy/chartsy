 ...
 */
public class T3MA extends Overlay
{
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i) {
        ...
        if (values.length > 0) {
            ...
            for (int j = 0; j < values.length; j++) {
                ht.put(getFontHTML(colors[j], "T3MA:"),
    ...
    public void calculate()
    {
        ...
        core.t3(0, count-1, initial.getCloseValues(), period, volumeFactor, outBegIdx, outNbElement, output);
