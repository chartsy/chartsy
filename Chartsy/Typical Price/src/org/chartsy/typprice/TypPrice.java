...
/**
 * The Typical Price Indicator
 *
 * @author joshua.taylor
 */
public class TypPrice extends Overlay
{
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i) {
        ...
        if (values.length > 0) {
            ...
            for (int j = 0; j < values.length; j++) {
                ht.put(getFontHTML(colors[j], "Typical Price:"),
    ...
    public void calculate()
    {
        ...
        lookback = core.typPriceLookback();
        core.typPrice(0, count-1, allHighs, allLows, initial.getCloseValues(), outBegIdx, outNbElement, output);
