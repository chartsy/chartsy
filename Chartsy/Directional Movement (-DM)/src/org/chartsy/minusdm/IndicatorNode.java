...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Directional Movement (-DM) Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Directional Movement (-DM) Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[(-DM) Line Node] : Method does not exist.", ex);
        }
