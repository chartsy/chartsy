 ...
 */
public class MinusDM extends Indicator{
    ...
    @Override
    public Indicator newInstance(){ return new MinusDM(); }
    ...
    public void calculate()
    {
        ...
        lookback = core.minusDMLookback(period);
        core.minusDM(0, count-1, allHigh, allLow, period, outBegIdx, outNbElement, output);
