...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Hilbert Transform Trend Mode Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Hilbert Transform Trend Mode Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Hilbert Transform Trend Mode Node] : Method does not exist.", ex);
        }
