...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Hilbert Transform Trendline Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Hilbert Transform Trendline Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Hilbert Transform Trendline Node] : Method does not exist.", ex);
        }
