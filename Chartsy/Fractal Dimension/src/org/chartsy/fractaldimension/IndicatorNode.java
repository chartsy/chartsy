...
public class IndicatorNode extends AbstractNode implements PropertyChangeListener, Externalizable {
    ...
    public IndicatorNode() {
        super(Children.LEAF);
        setDisplayName("Fractal Dimension Properties");
    }
    ...
    protected Sheet createSheet() {
        ...
        try {
            ...
            @SuppressWarnings(value = "unchecked")
            Property color14 = new PropertySupport.Reflection(indicatorProperties, Color.class, "getDelimiterColor", "setDelimiterColor") {
                public Object getValue() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException { return super.getValue(); }
                public void setValue(Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException { super.setValue(obj); }
                public void restoreDefaultValue() throws IllegalAccessException, InvocationTargetException { super.setValue(IndicatorProperties.DELIMITER_COLOR); }
                public boolean supportsDefaultValue() { return true; }
            };
            color14.setName("Delimiters Color");
            set.put(color14);

            // Delimiter Line Stroke
            @SuppressWarnings(value = "unchecked")
            PropertySupport.Reflection stroke14 = new PropertySupport.Reflection(indicatorProperties, Stroke.class, "getDelimiterStroke", "setDelimiterStroke") {
                public Object getValue() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException { return super.getValue(); }
                public void setValue(Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException { super.setValue(obj); }
                public void restoreDefaultValue() throws IllegalAccessException, InvocationTargetException { super.setValue(StrokeGenerator.getStroke(IndicatorProperties.DELIMITER_STROKE_INDEX)); }
                public boolean supportsDefaultValue() { return true; }
            };
            stroke14.setPropertyEditorClass(StrokePropertyEditor.class);
            stroke14.setName("Delimiters Line Style");
            set.put(stroke14);
