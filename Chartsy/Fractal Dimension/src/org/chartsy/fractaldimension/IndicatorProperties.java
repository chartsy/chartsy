        ...
        extends AbstractPropertyListener
{
    ...
    public static final String LABEL = "Fractal Dimension";
    ...
    public static final Color DELIMITER_COLOR = Color.BLUE;
    public static final int DELIMITER_STROKE_INDEX = 0;
    ...
    public void setDelimiterColor(Color c) { delimiterColor = c; }

    public int getDelimiterStrokeIndex() { return delimiterStrokeIndex; }
    public void setDelimiterStrokeIndex(int i) { delimiterStrokeIndex = i; }
    public Stroke getDelimiterStroke() { return StrokeGenerator.getStroke(delimiterStrokeIndex); }
    public void setDelimiterStroke(Stroke s) { delimiterStrokeIndex = StrokeGenerator.getStrokeIndex(s); }
