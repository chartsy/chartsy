 ...
 */
public class DEMA extends Overlay
{

    private static final long serialVersionUID = SerialVersion.APPVERSION;
    
    public static final String FULL_NAME = "Double Exponential MA";
    public static final String HASHKEY = "dema";
    ...
    public Overlay newInstance(){ return new DEMA(); }
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i) {
        ...
        if (values.length > 0) {
            ...
            for (int j = 0; j < values.length; j++) {
                ht.put(getFontHTML(colors[j], "DEMA:"),
    ...
    public void calculate()
    {
        ...
        core.dema(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
