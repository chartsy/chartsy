...
public class OverlayNode extends AbstractPropertiesNode {
    ...
    public OverlayNode()
    {
        super("Ermanometry Properties");
    }

    public OverlayNode(OverlayProperties overlayProperties)
    {
        super("Ermanometry Properties", overlayProperties);
    }
    ...
    public @Override Sheet.Set[] getSets()
    {
        ...
        try
        {
            ...
            // Seed Segment EF
            set.put(getProperty(
                    "Seed Segment EF (First Wave)", // property name
                    "Sets the seed segment ef value", // property description
                    OverlayProperties.class, // properties class
                    int.class, // property class
                    null, // property editor class (null if none)
                    "getSeedSegmentEF", // get method name
                    "setSeedSegmentEF", // set method name
                    OverlayProperties.SEED_SEGMENT_EF // default property value
                    ));
            // Seed Segment DE
            set.put(getProperty(
                    "Seed Segment DE (Second Wave)", // property name
                    "Sets the seed segment de value", // property description
                    OverlayProperties.class, // properties class
                    int.class, // property class
                    null, // property editor class (null if none)
                    "getSeedSegmentDE", // get method name
                    "setSeedSegmentDE", // set method name
                    OverlayProperties.SEED_SEGMENT_DE // default property value
                    ));
            // Label
            set.put(getProperty(
                    "Label", // property name
