 ...
 */
public class TRIMA extends Overlay
{
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i) {
        ...
        if (values.length > 0) {
            ...
            for (int j = 0; j < values.length; j++) {
                ht.put(getFontHTML(colors[j], "TRIMA:"),
    ...
    public void calculate()
    {
        ...
        lookback = core.movingAverageLookback(period, MAType.Trima);
        core.trima(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
