...
public class OverlayProperties extends AbstractPropertyListener
{
    ...
    public static final String LABEL = "Parabolic SAR";
    public static final boolean MARKER = true;
    public static Color COLOR;
    public static final int STROKE_INDEX = 0;
    public static final double DEFAULT_STEP = 0.02;//Wilder's recommendation
    public static final double DEFAULT_MAX_STEP = 0.20;//Wilder's recommendation
    ...
    private double maxStep = DEFAULT_MAX_STEP;
