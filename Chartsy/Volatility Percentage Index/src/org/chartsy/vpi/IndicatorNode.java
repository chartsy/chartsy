        ...
        extends AbstractPropertiesNode
{
    ...
    {
        super("Volatility Percentage Index Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Volatility Percentage Index Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[VPINode] : Method does not exist.", ex);
        }
