 ...
 * @author Viorel
 */
public class VolatilityPercentageIndex 
        extends Indicator
{
    ...
    public VolatilityPercentageIndex()
    {
        super();
    ...
    {
        return new VolatilityPercentageIndex();
    }
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i)
    {
        ...
        String[] labels = {"VPI:","MA (65):","MA (200):"};
    ...
    {
        Dataset vpiDataset = visibleDataset(cf, VPI);
