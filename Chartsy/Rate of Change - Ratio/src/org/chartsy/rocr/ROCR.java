...
/**
 * The Rate of Change - Ratio calculation
 *
 * @author joshua.taylor
 */
public class ROCR extends Indicator{

    private static final long serialVersionUID = SerialVersion.APPVERSION;
    public static final String FULL_NAME = "Rate of Change - Ratio";
    public static final String HASHKEY = "rocr";
    ...
    @Override
    public Indicator newInstance(){ return new ROCR(); }
    ...
    @Override
    public double[] getDelimitersValues(){ return new double[] {1}; }
    ...
    public void calculate()
    {
        ...
        lookback = core.rocRLookback(period);
        core.rocR(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
