...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Accumulation/Distribution Oscillator Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Accumulation/Distribution Oscillator Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        try
        {
            ...
            set.put(getProperty(
                    ...
                    "Sets the Fast Period Line", // property description
                    IndicatorProperties.class, // properties class
                    int.class, // property class
                    null, // property editor class (null if none)
                    "getFastPeriod", // get method name
                    "setFastPeriod", // set method name
                    IndicatorProperties.DEFAULT_FAST_PERIOD// default property value
                    ));
            // Slow Period
            set.put(getProperty(
                    "Slow Period", // property name
                    "Sets the Slow Period line", // property description
                    IndicatorProperties.class, // properties class
                    int.class, // property class
                    null, // property editor class (null if none)
        ...
        {
            LOG.log(Level.SEVERE, "[A/D Oscillator Node] : Method does not exist.", ex);
        }
