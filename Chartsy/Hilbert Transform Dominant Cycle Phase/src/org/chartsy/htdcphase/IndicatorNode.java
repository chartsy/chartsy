...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Hilbert Transform DC Phase Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Hilbert Transform DC Phase Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Hilbert Transform DC Phase Node] : Method does not exist.", ex);
        }
