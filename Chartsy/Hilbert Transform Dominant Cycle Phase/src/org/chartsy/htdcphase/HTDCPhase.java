...
/**
 * The Hilbert Transform Dominant Cycle Phase
 *
 * @author joshua.taylor
 */
public class HTDCPhase extends Indicator{

    private static final long serialVersionUID = SerialVersion.APPVERSION;
    public static final String FULL_NAME = "Hilbert Transform DC Phase (HT-DC Phase)";
    public static final String HASHKEY = "htdcphase";
    ...
    @Override
    public Indicator newInstance(){ return new HTDCPhase(); }
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i)
    {
        ...
        String[] labels = {"Hilbert Transform DC Phase:"};
    ...
    public void calculate()
    {
        ...
        lookback = core.htDcPhaseLookback();
        core.htDcPhase(0, count-1, initial.getCloseValues(), outBegIdx, outNbElement, output);
