...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Accumulation/Distribution Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Accumulation/Distribution Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[A/D Line Node] : Method does not exist.", ex);
        }
