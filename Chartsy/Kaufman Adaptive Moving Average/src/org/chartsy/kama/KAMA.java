 ...
 */
public class KAMA extends Overlay
{

    private static final long serialVersionUID = SerialVersion.APPVERSION;

    public static final String FULL_NAME = "Kaufman Adaptive MA";
    public static final String HASHKEY = "kama";
    ...
    public Overlay newInstance(){ return new KAMA(); }
    ...
    public LinkedHashMap getHTML(ChartFrame cf, int i) {
        ...
        if (values.length > 0) {
            ...
            for (int j = 0; j < values.length; j++) {
                ht.put(getFontHTML(colors[j], "KAMA:"),
    ...
    public void calculate()
    {
        ...
        lookback = core.movingAverageLookback(period, MAType.Kama);
        core.kama(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
