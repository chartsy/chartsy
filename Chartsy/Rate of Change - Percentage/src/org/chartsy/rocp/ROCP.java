...
/**
 * The Rate of Change - Percentage calculation
 *
 * @author joshua.taylor
 */
public class ROCP extends Indicator{

    private static final long serialVersionUID = SerialVersion.APPVERSION;
    public static final String FULL_NAME = "Rate of Change - Percentage";
    public static final String HASHKEY = "rocp";
    ...
    //the next variable is used for to hold indicator calculations
    ...
    @Override
    public Indicator newInstance(){ return new ROCP(); }
    ...
    public void calculate()
    {
        ...
        lookback = core.rocPLookback(period);
        core.rocP(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
