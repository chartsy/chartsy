...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Rate of Change - Percentage Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Rate of Change - Percentage Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Rate of Change - Percentage Node] : Method does not exist.", ex);
        }
