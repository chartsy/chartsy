...
public class StochRSI extends Indicator
{
    ...
    private static String FULL_NAME = "Stochastic RSI";
    ...
    { return properties.getLabel() + " (" + properties.getPeriod() + ", " + properties.getPeriodK() + ", " + properties.getPeriodD() + ")"; }
    ...
    public void calculate()
    {
        ...
        core.stochRsi(0, count-1, initial.getCloseValues(), period, periodK, periodD, MAType.Sma, outBegIdx, outNbElement, outputFastK, outputFastD);
