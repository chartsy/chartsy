 ...
 * @author Viorel
 */
public class FavoritesListView extends ListView
{

    protected ZebraJList jList;
    ...
    {
        list = super.createList();
        jList = new ZebraJList();
        list.setCellRenderer(jList.getCellRenderer());
        return list;
    }
