...
/**
 * The Rate of Change - Ratio x100 calculation
 *
 * @author joshua.taylor
 */
public class ROCR100 extends Indicator{

    private static final long serialVersionUID = SerialVersion.APPVERSION;
    public static final String FULL_NAME = "Rate of Change - Ratio x100";
    public static final String HASHKEY = "rocr100";
    ...
    @Override
    public Indicator newInstance(){ return new ROCR100(); }
    ...
    @Override
    public double[] getDelimitersValues(){ return new double[] {100}; }
    ...
    public void calculate()
    {
        ...
        lookback = core.rocR100Lookback(period);
        core.rocR100(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
