...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Rate of Change - Ratio x100 Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Rate of Change - Ratio x100 Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Rate of Change - Ratio x100 Node] : Method does not exist.", ex);
        }
