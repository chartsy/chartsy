...
public class OverlayNode extends AbstractPropertiesNode
{
    ...
    public OverlayNode()
    {
        super("Time Series Forcast Properties");
    }

    public OverlayNode(OverlayProperties overlayProperties)
    {
        super("Time Series Forcast Properties", overlayProperties);
    }
    ...
    public @Override Sheet.Set[] getSets()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[Time Series Forcast Node] : Method does not exist.", ex);
        }
