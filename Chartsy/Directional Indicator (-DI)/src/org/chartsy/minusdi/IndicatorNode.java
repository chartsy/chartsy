...
public class IndicatorNode extends AbstractPropertiesNode
{
    ...
    {
        super("Directional Indicator (-DI) Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties)
    {
        super("Directional Indicator (-DI) Properties", indicatorProperties);
    }
    ...
    protected @Override Sheet createSheet()
    {
        ...
        {
            LOG.log(Level.SEVERE, "[(-DI) Line Node] : Method does not exist.", ex);
        }
